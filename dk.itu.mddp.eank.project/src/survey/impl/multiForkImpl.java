...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>multi Fork</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link survey.impl.multiForkImpl#getMatcher <em>Matcher</em>}</li>
 *   <li>{@link survey.impl.multiForkImpl#getForkedquestions <em>Forkedquestions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class multiForkImpl extends MinimalEObjectImpl.Container implements multiFork {
	/**
	...
	protected EClass eStaticClass() {
		return surveyPackage.Literals.MULTI_FORK;
	}
		...
		if (matcher != null && matcher.eIsProxy()) {
			...
			if (matcher != oldMatcher) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, surveyPackage.MULTI_FORK__MATCHER, oldMatcher, matcher));
			}
		}
		return matcher;
	}
	...
	public void setMatcher(Choice newMatcher) {
		...
		matcher = newMatcher;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, surveyPackage.MULTI_FORK__MATCHER, oldMatcher, matcher));
	}
	...
	public EList<Question> getForkedquestions() {
		if (forkedquestions == null) {
			forkedquestions = new EObjectContainmentEList<Question>(Question.class, this, surveyPackage.MULTI_FORK__FORKEDQUESTIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case surveyPackage.MULTI_FORK__FORKEDQUESTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case surveyPackage.MULTI_FORK__MATCHER:
